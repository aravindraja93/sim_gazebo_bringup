...
launch_path = os.path.realpath(__file__).replace("test_gazebo.launch.py","")
...
with open('{:s}/test_params.json'.format(json_path)) as json_file:
...
if has_built_ros2_pkgs:
    ...
    print('''\n\n\nPLEASE RUN:\n 
        source {:s}; source /opt/ros/foxy/setup.bash; ros2 launch sim_gazebo_bringup test_gazebo.launch.py
        \n\n'''.format(src_ros2_ws))
    sys.exit()
